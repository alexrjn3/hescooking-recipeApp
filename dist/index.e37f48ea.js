...
var _webImmediateJs = require("core-js/modules/web.immediate.js"); //BUG:
 /*1
...
var _recipeRecommendViewJs = require("./views/recipeRecommendView.js");
var _recipeRecommendViewJsDefault = parcelHelpers.interopDefault(_recipeRecommendViewJs);
var _downloadRecipeViewJs = require("./views/downloadRecipeView.js");
var _downloadRecipeViewJsDefault = parcelHelpers.interopDefault(_downloadRecipeViewJs);
...
const controlRecipes = async function() {
    try {
        ...
        if (!id) {
            //6) Recommends tab
            (0, _historyViewJsDefault.default).render(_modelJs.getHistory());
            (0, _recipeRecommendViewJsDefault.default).renderSpinner();
            _modelJs.getRecommends();
            await _modelJs.loadSearchResults(_modelJs.state.recommend.keywords[0], true, _modelJs.state.recommend.keywords[1]);
            await _modelJs.getFullRecipesRecommend();
            (0, _recipeRecommendViewJsDefault.default).render(_modelJs.state.recommend.results);
            (0, _recipeRecommendViewJsDefault.default).generateRecommendSpanTitle();
            return;
        }
        // 1) spinner
        (0, _recipeViewJsDefault.default).renderSpinner();
        // 2) Update results view to mark selected search result. If it doesnt exist display history searches.
        if (!_modelJs.getSearchResultsPage().length) (0, _historyViewJsDefault.default).render(_modelJs.getHistory());
        else {
            (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResultsPage());
            _modelJs.leftTab(false); //false - lefttab activ cu results
        }
        // 3) Loading recipe
        ...
        //5) Add to history
        _modelJs.addHistory(_modelJs.state.recipe);
    } catch (err) {
...
const controlSearchResults = async function() {
    try {
        ...
        (0, _historyViewJsDefault.default).deleteHistorySpanTitle(); //nu merge???
        // 2) Load search query
        (0, _resultsViewJsDefault.default).renderSpinner(); //aicierr
...
const controlAddBookmark = function() {
    ...
    if (_modelJs.state.active_leftTab === true) (0, _historyViewJsDefault.default).render(_modelJs.getHistory());
    else (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResultsPage());
};
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        console.log('check2');
        //succes message
        (0, _addRecipeViewJsDefault.default).stopRenderSpinner();
...
const controlDeleteHistory = function() {
    ...
    _modelJs.deleteHistory();
    //2) Stergem butonul de delete history
    (0, _historyViewJsDefault.default).btnDisableDeleteHistory();
    //3)Update historyView
    (0, _historyViewJsDefault.default).update(_modelJs.getHistory());
};
const controlMenuPage = async function() {
    await (0, _navigationViewJsDefault.default).toggleMenu();
};
const controlDownloadRecipe = async function() {
    try {
        //Capture recipe
        await (0, _downloadRecipeViewJsDefault.default).captureAndDownload();
        (0, _downloadRecipeViewJsDefault.default).hideDownloadDirections();
    } catch (err) {
        console.error(err);
    }
};
const controlToogleBookmark = async function(id) {
    ...
    let exists = _modelJs.state.bookmarks.some((bookmark)=>bookmark.id === id);
    console.log(exists);
    if (exists) _modelJs.deleteBookmark(id, true);
    else {
        await _modelJs.getRecipe(id);
        _modelJs.addBookmark(_modelJs.state.result_recipe, true);
    }
  ...
  */ // if(flag === true) console.log("add");
    ...
    // 4) History view render:
    console.log(_modelJs.state.active_leftTab);
    if (_modelJs.state.active_leftTab === true) (0, _historyViewJsDefault.default).render(_modelJs.getHistory());
    else (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResultsPage());
};
const controlMenuClickItems = function(selected_item) {
    ...
    if (selected_item.classList.contains('nav_addRecipe')) {
        (0, _addRecipeViewJsDefault.default).clear();
        (0, _addRecipeViewJsDefault.default).toggleWindow();
        (0, _addRecipeViewJsDefault.default).generateForm();
        (0, _navigationViewJsDefault.default).toggleMenu();
        if ((0, _addRecipeViewJsDefault.default)._ingredients) (0, _addRecipeViewJsDefault.default)._ingredients.addEventListener('input', function(event) {
            (0, _addRecipeViewJsDefault.default)._generateIngredients(event.target.value);
        });
    }
};
const init = function() {
    ...
    (0, _navigationViewJsDefault.default).addHandlerHome(controlHomePage);
    (0, _navigationViewJsDefault.default).addHandlerOpenMenu(controlMenuPage);
    (0, _navigationViewJsDefault.default).addHandlerCloseMenu(controlMenuPage);
    (0, _historyViewJsDefault.default).addHandlerDeleteHistory(controlDeleteHistory);
    (0, _downloadRecipeViewJsDefault.default).addHandlerDownloadRecipe(controlDownloadRecipe);
    (0, _resultsViewJsDefault.default).addHandlerAddBookmark(controlToogleBookmark);
    (0, _bookmarksViewJsDefault.default).addHandlerAddBookmark(controlToogleBookmark);
    (0, _navigationViewJsDefault.default).addHandlerMenuClickItems(controlMenuClickItems);
    (0, _historyViewJsDefault.default).generateHistorySpanTitle();
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config.js":"k5Hzs","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/bookmarksView.js":"4Lqzq","./views/paginationView.js":"6z7bi","./views/addRecipeView.js":"i6DNj","./views/historyView.js":"dVOhu","./views/navigationView.js":"it1BP","./views/recipeRecommendView.js":"6O4xr","./views/downloadRecipeView.js":"ixFrB","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports,__globalThis) {
'use strict';
...
parcelHelpers.export(exports, "addHistory", ()=>addHistory);
parcelHelpers.export(exports, "getHistory", ()=>getHistory);
parcelHelpers.export(exports, "getRecommends", ()=>getRecommends);
parcelHelpers.export(exports, "getFullRecipesRecommend", ()=>getFullRecipesRecommend);
parcelHelpers.export(exports, "leftTab", ()=>leftTab);
...
const getRecipe = async function(id) {
    try {
        ...
        if (state.bookmarks.some((bookmark)=>bookmark.id === id)) state.result_recipe.bookmarked = true;
...
const loadSearchResults = async function(query, sixResults = false, query2) {
    try {
        ...
        if (!sixResults) {
            ...
            const data2 = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}?search=${query2}&key=${(0, _configJs.KEY)}`);
            console.log(data2);
...
const addBookmark = function(recipe, bookmarkComesFromMenu = false) {
    console.log(recipe);
...
const deleteBookmark = function(id, bookmarkComesFromMenu = false) {
...
const uploadRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith('ingredients') && entry[1] !== '').map((ing)=>{
            const ingArr = ing[1].split(',').map((el)=>el.trim());
            if (ingArr.length !== 3) throw new Error('Wrong ingredient format! Please use the corect format :)');
...
const addHistory = function(recipe) {
    ...
    if (index !== -1) {
        ...
        if (state.history[index].bookmarked !== recipe.bookmarked) state.history[index].bookmarked = recipe.bookmarked;
...
const getHistory = function() {
    ...
    state.history.forEach((his)=>{
        ...
        console.log(index);
        if (index === -1) his.bookmarked = false;
        else his.bookmarked = true;
        console.log(his);
    });
    console.log(state.history);
        ...
        state.recommend.recommendsCount.forEach((wordCount, index)=>{
            if (!state.recommend.pozFalse.includes(index)) {
                if (wordCount > max1) {
                    ...
                    max1 = wordCount;
                    poz1 = index;
                    console.log('poz wordCount:' + state.recommend.recommendsCount.indexOf(wordCount));
    ...
    try {
        state.history.forEach((his)=>{
            his.title.split(/[ ,\.]+/).forEach((char)=>{
                ...
                } else state.recommend.recommendsCount[[
                    ...state.recommend.recommends
                ].indexOf(char)]++;
            });
        });
        ...
        if (poz1 !== false) state.recommend.keywords.push([
            ...state.recommend.recommends
        ][`${poz1}`]);
        if (poz2 !== false) state.recommend.keywords.push([
            ...state.recommend.recommends
        ][`${poz2}`]);
    } catch (err) {
        throw err;
...
const getFullRecipesRecommend = async function() {
    console.log(state.recommend.results);
    try {
        state.recommend.results = await Promise.all(state.recommend.results.map(async (item)=>{
            let data = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}${item.id}?key=${(0, _configJs.KEY)}`);
            return {
                ...item,
...
//aici variabile care definesc aplicatia noastra:
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const KEY = 'aab3b486-a8ef-48b9-8e9f-027dd2b576b3';
...
export const sendJSON = async function (url, uploadData) {
  try {
    //la send data trebuie sa cream un obiect:
...
var _iconsSvg = require("../../img/icons.svg"); //pt video si image trb url: la inceput la parcel v2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _fractionalJs = require("../libraries/fractional.js");
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
      ...
      <div class="recipe__directions">
        ...
        <button class="btn--small downloadrec__btn">
          <span>Download</span>
          <svg class="search__icon">
            <use href="${0, _iconsSvgDefault.default}#icon-arrow-right"></use>
          </svg>
    ...
    _generateMarkupIngredient(ing) {
        return `
         ...
         <div class="recipe__quantity">${ing.quantity ? new (0, _fractionalJs.Fraction)(ing.quantity).toString() : ' '}</div>
    ...
    addHandlerRender(handler) {
        //cand avem mai multe eventuri pt acelasi element putem folosi comanda de
        [
            'hashchange',
            'load'
    ...
    addHandlerUpdateServings(handler) {
        //event delegation:
        //Structuri HTML Complexe: Într-o structură HTML complexă, elementul pe care dai clic (de exemplu, o etichetă span în interiorul unui buton) ar putea să nu aibă clasa dorită, dar părintele său ar putea să o aibă. closest urcă în arborele DOM pentru a găsi elementul cu clasa specificată, asigurându-se că gestionarea evenimentelor este corectă.
...
},{"./View.js":"5cUXS","../../img/icons.svg":"cMpiy","../libraries/fractional.js":"kxrOu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg"); //pt video si image trb url: la inceput la parcel v2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cMpiy":[function(require,module,exports,__globalThis) {
...
},{}],"kxrOu":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./View.js":"5cUXS","./previewView.js":"1FDQ6","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1FDQ6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"5cUXS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4Lqzq":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"5cUXS","./previewView.js":"1FDQ6","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6z7bi":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"5cUXS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i6DNj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class addRecipeView extends (0, _viewJsDefault.default) {
    ...
    addHandlerShowWindow(btnOp = this._btnOpen) {
        btnOp.addEventListener('click', ()=>{
            ...
            if (this._ingredients) this._ingredients.addEventListener('input', (function() {
    ...
    _generateIngredients(value) {
        ...
        let markup = '';
        console.log(value);
        for(let i = 1; i <= value; i++)markup += `<label for="detailsInput${i}">Ingredient ${i}:</label><input type='text'  id="detailsInput${i}" name="ingredients${i}" required placeholder="Format: 'Quantity,Unit,Description'"/>`;
        console.log(markup);
...
},{"./View.js":"5cUXS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dVOhu":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
var _iconsSvg = require("../../img/icons.svg"); //pt video si image trb url: la inceput la parcel v2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class HistoryView extends (0, _viewJsDefault.default) {
    _parentElement = document.querySelector('.results');
...
},{"./View.js":"5cUXS","./previewView.js":"1FDQ6","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"it1BP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg"); //pt video si image trb url: la inceput la parcel v2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6O4xr":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
var _iconsSvg = require("../../img/icons.svg"); //pt video si image trb url: la inceput la parcel v2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class RecipeRecommendView extends (0, _viewJsDefault.default) {
    _parentElement = document.querySelector('.recipe');
    _errorMessage = `Start by searching for a recipe or an ingredient. At next use we will have suggestions for you!`;
    _message = '';
    _generateMarkup() {
        let markup = this._data.map((result, i)=>this._generateMarkups(result, i));
    ...
    <a class="previewRec__link" href="#${rez.id}">
      ...
      <div class="previewRec__data">
        ...
        <div class="recipe__infoRec">
          ...
          <span class="recipe__infoRec-dataRec recipe__info-data--minutes">${rez.cookingTime}</span>
...
exports.default = new RecipeRecommendView();

},{"./View.js":"5cUXS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ixFrB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
var _domToImageDefault = parcelHelpers.interopDefault(_domToImage);
class DownloadRecipeView extends (0, _viewJsDefault.default) {
    _parentElement = document.querySelector('.recipe');
    _errorMessage = `No history found `;
    _message = '';
    ...
    async captureAndDownload() {
        ...
        (0, _domToImageDefault.default).toPng(this._parentElement).then(function(dataUrl) {
...
exports.default = new DownloadRecipeView();

},{"./View.js":"5cUXS","../../img/icons.svg":"cMpiy","dom-to-image":"eVACg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eVACg":[function(require,module,exports,__globalThis) {
(function(global) {
    'use strict';
    var util = newUtil();
    ...
    function copyOptions(options) {
        ...
        if (typeof options.imagePlaceholder === 'undefined') domtoimage.impl.options.imagePlaceholder = defaultOptions.imagePlaceholder;
        else domtoimage.impl.options.imagePlaceholder = options.imagePlaceholder;
        if (typeof options.cacheBust === 'undefined') domtoimage.impl.options.cacheBust = defaultOptions.cacheBust;
        else domtoimage.impl.options.cacheBust = options.cacheBust;
    }
    ...
    function newUtil() {
        ...
        function getAndEncode(url) {
            var TIMEOUT = 30000;
            if (domtoimage.impl.options.cacheBust) // Cache bypass so we dont have CORS issues with cached images
            ...
            return new Promise(function(resolve) {
                ...
                if (domtoimage.impl.options.imagePlaceholder) {
                    ...
                    if (split && split[1]) placeholder = split[1];
                }
                function done() {
                    if (request.readyState !== 4) return;
                    if (request.status !== 200) {
                        if (placeholder) resolve(placeholder);
                        else fail('cannot fetch resource: ' + url + ', status: ' + request.status);
                        return;
                    }
                ...
                function timeout() {
                    if (placeholder) resolve(placeholder);
                    else fail('timeout of ' + TIMEOUT + 'ms occured while fetching resource: ' + url);
                }
    ...
    function newInliner() {
        ...
        function readUrls(string) {
            var result = [];
            var match;
            while((match = URL_REGEX.exec(string)) !== null)result.push(match[1]);
